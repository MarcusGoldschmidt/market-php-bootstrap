    ...
    <div class="menu-top">
        <div class="col-md-10">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <h3 class="menu">Consulta Empresas</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <div class="topico">
                        <ul class="nav navbar-nav">
                            <li><a href="empresa-cadastro.php">Cadastrar</a></li>
                            <li class="active"><a href="empresa-consulta.php">Consultar</a></li>
                        </ul>
                    </div>
                </ul>
            </div>
        ...
        <div class="row content">
            ...
            <div class="col-sm-10">
                <div class="row">
                    ...
                    <form method="post" action="empresa-consulta.php">
                        <div class="col-sm-2">
                ...
                <div class="consulta-cliente-fisico">
                    <table class="table table-hover table-striped">
                        ...
                        <?php 
                            ...
                            if ($_GET) $idempresa = $_GET{'idempresa'}; else $idempresa = "";
                        ...
                        if($idempresa){
                            ...
                            if ($_POST) $busca = $_POST{'buscar'}; else $busca = "";
                                       
                                        $sql = "select * from empresa where nomeempresa like :nome";
                                        $resultados = $conexao->prepare($sql);
                                        $resultados->bindValue(":nome", "%".$busca."%"); //foi feito direto para pegar o valor do nome que é o input de pesquisa
                                        $resultados->execute();
                                        //sql
                                        ...
                                        foreach($resultados as $linha){
                                            ...
                                            echo "<td><a href='empresa-alterar.php?idempresa=".$linha['idempresa']."'<button class='btn btn-warning'><span class='glyphicon glyphicon-pencil'></span> Alterar</button></a></td>";
                                            echo "<td><a href='empresa-consulta.php?idempresa=".$linha['idempresa']."'><button class='btn btn-danger'><span class='glyphicon glyphicon-remove'></span>Excluir</button></a></td>";
