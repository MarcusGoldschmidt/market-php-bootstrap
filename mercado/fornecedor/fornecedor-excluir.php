    ...
    <div class="menu-top">
        <div class="col-md-10">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <h3 class="menu">Página Cliente</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="cliente-inicio.php">Inicio Cliente</a></li>
        ...
        <div class="row content">
            <div class="col-sm-2 sidenav hidden-xs">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="cliente-fisico-inicio.php">Pessoa fisica</a></li>
                    <div class="topico">
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="cliente-fisico-cadastro.php">Cadastrar</a></li>
                            <li><a href="cliente-fisico-consulta.php">Consultar</a></li>
            ...
            <div class="col-sm-10">
                ...
                <?php
                    ...
                    $excluir->bindValue(":idfornecedor", $_GET['idfornecedor']);
                    $excluir->execute();
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="cliente-fisico-cadastro.php">
                                <div class="well">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <h2>Cadastrar</h2>
                        ...
                        <div class="col-sm-3">
                            <a href="cliente-fisico-consulta.php">
                                <div class="well">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <h2>Consultar</h2>
