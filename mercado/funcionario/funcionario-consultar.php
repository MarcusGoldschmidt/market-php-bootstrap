    ...
    <div class="menu-top">
        <div class="col-md-10">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <h3 class="menu">Consulta Funcionário</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <div class="topico">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="funcionario-consultar.php">Consultar</a></li>
                        </ul>
                    </div>
                </ul>
            </div>
        ...
        <div class="row content">
            ...
            <div class="col-sm-10">
                <div class="row">
                    ...
                    <form method="post" action="funcionario-consultar.php">
                        <div class="col-sm-2">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <?php
                            ...
                            if($_GET){
                                ...
                                $delete->bindValue(":idfuncionario", "%".$_GET['idfuncionario']."%");
                            ...
                            if ($_POST) $nome = $_POST{'buscar'}; else $nome = "";
                                        ...
                                        $sql = "select * from funcionario
                                                inner join empresa
                                                on idempresa = empresa_idempresa where nome like :nome";
                                        ...
                                        foreach($resultados as $linha){
                                            ...
                                            echo "<td><a href='funcionario-alterar.php?idfuncionario=".$linha['idfuncionario']."'<button class='btn btn-warning'><span class='glyphicon glyphicon-pencil'></span> Alterar</button></a></td>";
                                            echo "<td><a href='funcionario-consultar.php?idfuncionario=".$linha['idfuncionario']."'><button class='btn btn-danger'><span class='glyphicon glyphicon-remove'></span>Excluir</button></a></td>";
