    ...
    <div class="menu-top">
        <div class="col-md-10">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <h3 class="menu">Página Funcionário</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="funcionario-inicio.php">Inicio Funcionário</a></li>
        ...
        <div class="row content">
            <div class="col-sm-2 sidenav hidden-xs">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="../venda/venda-cadastro.php">Realizar Venda</a></li>
                    <li><a href="../entrega/entrega-cadastro.php">Entregas</a></li>
                    <li class="active"><a href="funcionario-inicio.php">Funcionário</a></li>
                    <div class="topico">
                        <ul class="nav nav-pills nav-stacked">
            ...
            <div class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <a href="funcionario-cadastro.php">
                            <div class="well">
                                <div class="row">
                                    <div class="col-sm-8">
                                        <h2>Cadastrar</h2>
                    ...
                    <div class="col-sm-3">
                        <a href="funcionario-consultar.php">
                            <div class="well">
                                <div class="row">
                                    <div class="col-sm-8">
                                        <h2>Consultar</h2>
