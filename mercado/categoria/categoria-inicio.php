    ...
    <div class="menu-top">
        <div class="col-md-10">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <h3 class="menu">Página Categoria</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="categoria-inicio.php">Inicio Categoria</a></li>
        ...
        <div class="row content">
            ...
            <div class="col-sm-10">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <a href="categoria-consultar.php">
                            <div class="well">
                                <div class="row">
                                    <div class="col-sm-8">
                                        <h2>Consultar</h2>
